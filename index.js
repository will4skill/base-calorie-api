...
// 4. https://codewithmosh.com/p/the-complete-node-js-course
  ...
  BaseCalorie_Service: {
    BaseCalorie_Port: {
      getCalories: function(args) {
        let bmr = 10*Number(args.weight_lbs['$value'])/2.205 +
          6.25*2.54*Number(args.height_in['$value']) -
          5*Number(args.age_yrs['$value']);
        if (args.sex === "f") {
          bmr -= 161;
        } else {
          bmr += 5;
